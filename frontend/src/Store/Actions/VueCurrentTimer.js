...
export const vueShortBreakTimerAction = (payload) => ({ type: CHANGE_TO_SHORT_BREAK, payload })
export const vueLongBreakTimerAction = (payload) => ({ type: CHANGE_TO_LONG_BREAK, payload })