        ...
        settings: {
          ...
          user : {
            ...
            TimerSettings: {
              ...
              DefaultDuration: state.settings.user.TimerSettings.DefaultDuration = action.payload }
          }
      }
      }
      ...
      return { ...state,
        settings: {
          ...
          user : {
            ...
            TimerSettings:  {
              ...state.settings.user.TimerSettings,
              LongBreakDuration: state.settings.user.TimerSettings.LongBreakDuration = action.payload
            }
          }
        }
      }
        ...
        return { ...state,
          settings: {
            ...
            user : {
              ...
              TimerSettings: {
                ...state.settings.user.TimerSettings,
                ShortBreakDuration: state.settings.user.TimerSettings.ShortBreakDuration = action.payload
              }
            }
          }
        }
      ...
      return {...state,
        settings: {
          ...
          user : {
            ...
            TimerSettings: {
              ...state.settings.user.TimerSettings,
              TickTrack: state.settings.user.TimerSettings.TickTrack = action.payload
            }
          }
        }
      }
    case GET_SETTINGS:
      return {...state,
        ...
        ...state.settings,
          ...
          ...state.settings.user,
            TimerSettings : {
            ...state.settings.user.TimerSettings, ...action.payload}
          }
        }}
    default:
      return state
...
export const getLoginAction = (payload) => ({ type: LOGIN_GET_SETTINGS, payload });
...
export const changeLongBreakAction = (payload) => ({ type: CHANGE_LONG_BREAK, payload })
